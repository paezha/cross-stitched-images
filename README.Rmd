...
In this notebook I read an image and then create a plot with the aspect of woven art. 
...
Plot the image. This image is courtesy of my talented cousin [Dolores Robles Martinez](https://www.instagram.com/doloresrobles_m/?hl=en):
```{r}
plot(im)
```
